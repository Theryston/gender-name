...
<div className="home-content">
  <div className="content-container hero-container">
    ...
    <p className="subtitle">
      Simple, free, open source, without API key and unlimited. <br className='sm:block hidden'/> Predict a person's gender with just a GET request
    </p>
    <p className="subtitle">
    ...
    <div className="content-container">
      <Features>
        ...
        <Feature index={10} large>
          <h3>And more...</h3>
          <p>Continuously Updated / Open Source Models... <br/>Several free benefits, start enjoying them now!</p>
